        ...
        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
            <div class="widget widget-card-one">
                <div class="widget-content">
                    ...
                    <div class="media">
                        <div class="w-img">
                            <img src="{{ asset('assets/assets/img/profile-32.jpeg')}}" alt="avatar">
                        </div>
                ...
                <div class="widget-content">
                    ...
                    <div class="header">
                        ...
                        <div class="task-action">
                            <div class="dropdown  custom-dropdown">
                                <a class="dropdown-toggle" href="index2.html#" role="button" id="pendingTask" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-horizontal"><circle cx="12" cy="12" r="1"></circle><circle cx="19" cy="12" r="1"></circle><circle cx="5" cy="12" r="1"></circle></svg>
                                </a>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
            <div class="widget widget-card-two">
                <div class="widget-content">
                    ...
                    <div class="media">
                        <div class="w-img">
                            <img src="{{ asset('assets/assets/img/g-8.png')}}" alt="avatar">
                        </div>
                        <div class="media-body">
                    ...
                    <div class="card-bottom-section">
                        ...
                        <div class="img-group">
                            <img src="{{ asset('assets/assets/img/profile-19.jpeg')}}" alt="avatar">
                            <img src="{{ asset('assets/assets/img/profile-6.jpeg')}}" alt="avatar">
                            <img src="{{ asset('assets/assets/img/profile-8.jpeg')}}" alt="avatar">
                            <img src="{{ asset('assets/assets/img/profile-3.jpeg')}}" alt="avatar">
                        </div>
